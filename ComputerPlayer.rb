...
class ComputerPlayer
  ...
  def calculatePointsByDefense
    ...
    @columns.times do |c|
      ...
      for consecutive in (1..3)
        column.each_cons(consecutive) do |i|
          if i.uniq.length == 1 && i.uniq[0] == opponent && column[currentRow - 1] == empty
    ...
    for index in (firstIndex..lastIndex)
      ...
      if @fields[index] == opponent && @fields[index - @columns + 1] == opponent && @fields[index - (@columns * 2) + 2] == empty
    ...
    for index in (firstIndex..lastIndex)
      ...
      if @fields[index] == opponent && @fields[index - @columns + 1] == opponent && \
           @fields[index - (@columns * 2) + 2] ==  opponent && @fields[index - (@columns * 3) + 3] == empty
  ...
  def calculatePointsByOffense
    ...
    @columns.times do |c|
      ...
      for consecutive in (1..3)
        column.each_cons(consecutive) do |i|
          if i.uniq.length == 1 && i.uniq[0] == me && column[currentRow - 1] == empty
            if consecutive == 3
    ...
    for index in (firstIndex..lastIndex)
      next if index % @columns < 3 # position is to close to the left edge of board
      if @fields[index] == me && @fields[index - @columns - 1] == me && @fields[index - (@columns * 2) - 2] == empty
        @points[index - (@columns * 2) - 2] += 4
      end
    end
    ...
    for index in (firstIndex..lastIndex)
      next if index % @columns < 3 # position is to close to the left edge of board
      if @fields[index] == me && @fields[index - @columns - 1] == me && \
           @fields[index - (@columns * 2) - 2] ==  me && @fields[index - (@columns * 3) - 3] == empty
